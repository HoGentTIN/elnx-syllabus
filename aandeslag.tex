...
\begin{enumerate}
  ...
  \item Creëer een nieuwe *branch* om je eigen code en documentatie bij te houden. Verderop wordt duidelijk waarom dit belangrijk is. Kies bijvoorbeeld je eigen naam:

    \begin{minted}[gobble=6]{console}
      $ git checkout -b bertvv
    \end{minted}
