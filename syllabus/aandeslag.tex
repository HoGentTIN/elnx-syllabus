...
Bewerk alle bestanden met conflicten en verbeter de code. Vervolgens voeg je alle aangepaste bestanden toe met \texttt{git add .} en kan je het rebase-proces verder zetten met \verb|git rebase --continue|. Gebruik tussendoor regelmatig \texttt{git status} om te zien hoe ver je staat en welke commando's je nodig hebt om een stap verder te gaan.
